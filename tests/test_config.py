...
class TestAuthorizedUserIds:
    ...
    def test_defaults_to_chat_id_for_private_chat(self) -> None:
    ...
    def test_explicit_allowlist_overrides_chat_id(self) -> None:
        settings = Settings(
    ...
    def test_group_chat_id_without_allowlist_is_rejected(self) -> None:
    ...
    def test_group_chat_id_with_allowlist_is_accepted(self) -> None:
        settings = Settings(
    ...
    def test_non_numeric_allowlist_is_rejected(self) -> None:
    ...
    def test_negative_user_id_in_allowlist_is_rejected(self) -> None:
